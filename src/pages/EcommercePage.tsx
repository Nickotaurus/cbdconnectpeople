...
import { Filter, Search, Globe, ExternalLink, Check, Star } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
          ...
          {user && user.role === "store" && (
            <div className="bg-primary/5 rounded-lg p-4 mb-8 max-w-lg mx-auto">
              <p className="text-sm">
                Vous avez un site e-commerce CBD ? <Button variant="link" className="p-0 h-auto">Ajoutez-le à notre répertoire</Button>
              </p>
            </div>
          )}
        </div>
