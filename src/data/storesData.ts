...
let storesData: Store[] = [
  ...
  },
  {
    ...
    description: "Boutique spécialisée dans les produits CBD en Bretagne. Notre boutique à Quimper propose une large sélection de produits de qualité issus du chanvre.",
    imageUrl: "https://images.unsplash.com/photo-1591291621164-2c6367723315?q=80&w=1000",
    rating: 4.9,
    reviewCount: 78,
    coupon: {
      code: "CHANVRE15",
      discount: "15% sur tout le magasin",
      validUntil: "31/12/2024",
      usageCount: 23,
      isAffiliate: false,
    },
    ...
    reviews: [
      {
        ...
        date: "2024-01-15",
        rating: 5,
        text: "Excellente boutique avec des produits de qualité et un personnel très compétent et à l'écoute.",
        category: "experience",
      },
      {
        id: "r14",
        ...
        date: "2023-12-10",
        rating: 5,
        text: "Les huiles CBD sont d'une qualité remarquable, avec un effet apaisant durable.",
        category: "oils",
      },
      {
        id: "r15",
        ...
        date: "2023-11-22",
        rating: 4,
        text: "Très bon choix de fleurs CBD, avec des variétés qu'on ne trouve pas ailleurs.",
        category: "flowers",
      },
      {
        id: "r16",
        ...
        date: "2024-02-05",
        rating: 5,
        text: "J'apprécie particulièrement leurs cosmétiques au chanvre, ma peau les adore!",
        category: "originality",
      },
    ],
    products: [
      { category: "Fleurs", origin: "France", quality: "Bio" },
      { category: "Huiles", origin: "Bretagne", quality: "Premium" },
      { category: "Cosmétiques", origin: "France", quality: "Artisanal" },
    ],
  }
];
